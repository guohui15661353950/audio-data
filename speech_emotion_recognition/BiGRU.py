...
from keras.layers import Masking, Dropout, Dense, Activation, Embedding, Reshape, Flatten, advanced_activations, \
...
for item in datasets:
    ...
    model.add(Bidirectional(GRU(400, init='glorot_uniform', inner_init='orthogonal',
                                activation='tanh',
    ...
    model.add((GRU(800, init='glorot_uniform', inner_init='orthogonal',
                   activation='tanh',
                   inner_activation='hard_sigmoid', W_regularizer=regularizers.l2(0.0005),
                   U_regularizer=regularizers.l2(0.0005), b_regularizer=regularizers.l2(0.005),
                   dropout_W=0., dropout_U=0.,
    ...
    model.fit(train_set_x, train_set_y, nb_epoch=250, batch_size=64,  #
              ...
              callbacks=[early_stopping, history, tb_cb, PE])  # [early_stopping,history,checkpointer]
